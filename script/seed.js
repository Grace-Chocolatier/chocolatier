...
async function seed () {
  ...
  const products = await Promise.all([
    ...
    Product.create({name: 'Akosombo Bar 68%', imageUrl: 'bar_Acosombo.png', category: 'bar', price: 7, description: 'Intense dark chocolate with notes of roasted coffee.'}),
    Product.create({name: 'Coro Bar 100%', imageUrl: 'bar_Coro.png', category: 'bar', price: 7, description: 'Pure cocoa, this bar is the most intense.'}),
    Product.create({name: 'Cuana Bar 74%', imageUrl: 'bar_Cuana.png', category: 'bar', price: 7, description: 'Robust pure dark chocolate.'}),
    Product.create({name: 'Marao Bar 60%', imageUrl: 'bar_Marao.png', category: 'bar', price: 7, description: 'Dark chocolate with bursts of roasted almond.'}),
    Product.create({name: 'Monsera Bar 37%', imageUrl: 'bar_Monsera.png', category: 'bar', price: 7, description: 'Milk chocolate with pronounced notes of cacao.'}),
    Product.create({name: 'Orinoco Bar 60%', imageUrl: 'bar_Orinoco.png', category: 'bar', price: 7, description: 'Floral and full-bodied dark chocolate.'}),
    Product.create({name: 'Tolima Bar 37%', imageUrl: 'bar_Tolima.png', category: 'bar', price: 7, description: 'Milk chocolate with crispy cereals.'}),
